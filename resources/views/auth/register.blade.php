<x-layout>
     ...
     <div>
                ...
                <div class="relative">
                  ...
                  <input id="name-input" name="name" class="nx-input" style="padding-left:38px;padding-right:80px" placeholder="your name" >
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input id="pw" placeholder="********" type="password" name="password" class="nx-input" style="padding-left:38px;padding-right:48px">
