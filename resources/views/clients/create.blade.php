<x-dashboard-layout>
  ...
  <form method="POST" action="/clients" class="flex flex-col gap-5">
      @csrf
    <div class="flex justify-between">
      ...
      <input class="nx-input" name="name" placeholder="Client Name">
        </div>
      ...
      <input class="nx-input" name="DNI" placeholder="Client DNI">
        </div>
    </div>
      ...
      <input class="nx-input" name="address" placeholder="Client Address">
        </div>
      ...
      <input class="nx-input" name="phone_number" placeholder="Client Phone Number">
        </div>
      ...
      <input class="nx-input" name="email" placeholder="Client Email">
        </div>
